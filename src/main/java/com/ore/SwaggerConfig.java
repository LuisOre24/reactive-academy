...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Luis Ore", "https://github.com/LuisOre24",
			"luis_ore_24@hotmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("AppRest WebFlux Api Documentation", "AppRest WebFlux Api Documentation", "1.0",
